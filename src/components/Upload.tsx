...
export function Upload(){
 ...
 return <main className="page upload-page"><div className="page-heading"><div><span className="eyebrow">RESEARCH WORKSPACE / PUBLISH</span><h1>Upload a case</h1><p>This uploader prepares a GitHub Release. It does not upload files to Google Drive.</p></div><span className="badge">GitHub Releases</span></div>
